...
void saveFrameBuff(const char* fileName, GLuint new_fbo, GLuint width, GLuint height)
{
    ...
    printf("GL_IMPLEMENTATION_COLOR_READ_FORMAT of GL_FRAMEBUFFER is 0x%x\n", format);
    printf("GL_IMPLEMENTATION_COLOR_READ_TYPE of GL_FRAMEBUFFER is 0x%x\n", type);
    ...
    switch (format)
    {
        ...
        case GL_RGB:
            ...
            break;
        default:
            printf("!!!!! Not a valid color format: 0x%x\n", format);
            return;
    }
